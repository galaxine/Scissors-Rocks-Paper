...
function playerSelection() {
    let input = prompt(
        "Make sure you are entering either rock, paper or scissor. Upper or lower case doesn't really matter, just make sure you write it with the correct spelling.",
        ''
    ).toLowerCase();
    if (input === 'rock') {
        return 1;
